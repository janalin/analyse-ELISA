...
xlsx.file <- paste0(here::here(),
  "/../../PROJECTS/vaccine_response/data-raw/elisa_igg_igm/180821-HV_first_test_IgG.xlsx")
# Import excel data
data <- gdata::read.xls(xlsx.file, sheet = 1, header = FALSE) %>% as.tibble
...
```{r, plate-reader, echo = FALSE, eval = TRUE, warning = FALSE, message = FALSE}
## add titer data
titer.file <- paste0(here::here(), "/../../PROJECTS/vaccine_response/data/postprocess-HV_data.csv")
titer <- readr::read_csv(titer.file)
